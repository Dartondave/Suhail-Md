...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || process.env.IMAGE || "https://github.com/Gojo-Bots/Gojo_Satoru/blob/main/extras%2Fgojo_satoru__psd__by_at_yomiko_deyaec4-pre.jpg" ; // SET LOGO FOR IMAGE 
...
module.exports = {
  ...
  ownername:process.env.OWNER_NAME|| "It'x 𝔻𝔸ℝ𝕋𝕆ℕ",
...
// ========================= [ Disables in V.1.2.8 ] ===============================\\  
  ...
  //userImages:process.env.USER_IMAGES|| "https://imgur.com/gallery/satoru-nY5WgLa, https://imgur.com/gallery/satoru-gojou-gif-GPnvY58",  // SET IMAGE AND VIDEO URL FOR BOT MENUS 
